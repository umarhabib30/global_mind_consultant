...
class IeltsPopupController extends Controller
{
    public function index()
    {
        $popups = IeltsPopup::latest()->get();

        return view('admin.ielts-popup.index', [
            'heading' => 'IELTS Popup',
            'title' => 'View IELTS Popups',
            'active' => 'ielts-popup',
            'popups' => $popups,
        ]);
    }
    ...
    {
        return view('admin.ielts-popup.create', [
            'heading' => 'IELTS Popup',
            'title' => 'Create IELTS Popup',
            'active' => 'ielts-popup',
        ]);
    }
    ...
    {
        IeltsPopup::create($this->validatedData($request));

        return redirect()->route('ielts-popup.index')->with('success', 'IELTS popup created successfully.');
    }

    public function edit(string $id)
    {
        $popup = IeltsPopup::findOrFail($id);

        return view('admin.ielts-popup.edit', [
            'heading' => 'IELTS Popup',
            'title' => 'Edit IELTS Popup',
            'active' => 'ielts-popup',
            'popup' => $popup,
        ]);
    }
    ...
    {
        $popup = IeltsPopup::findOrFail($request->id);
        $popup->update($this->validatedData($request, $popup));

        return redirect()->route('ielts-popup.index')->with('success', 'IELTS popup updated successfully.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('ielts-popup.index')->with('success', 'IELTS popup deleted successfully.');
    }

    private function validatedData(Request $request, ?IeltsPopup $popup = null): array
    {
        ...
        if ($request->hasFile('image')) {
            ...
            $destination = public_path('uploads/ielts-popup');
            ...
            $imagePath = 'uploads/ielts-popup/' . $filename;
        }
