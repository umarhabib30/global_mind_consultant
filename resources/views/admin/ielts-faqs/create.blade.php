        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card shadow-lg rounded-lg border-0">
                <div class="card-header d-flex justify-content-between align-items-center" style="background-color: #0A245D;">
                    <h5 class="text-white mb-0">Add IELTS FAQ</h5>
                    <a href="{{ route('ielts-faqs.index') }}" class="btn admin-btn admin-btn-secondary admin-btn-sm">
                        Back to FAQs
                    </a>
                </div>
                ...
                <div class="card-body p-5">
                    ...
                    <form action="{{ route('ielts-faqs.store') }}" method="POST">
                        @csrf
