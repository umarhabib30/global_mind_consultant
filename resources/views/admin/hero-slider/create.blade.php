    ...
    <div class="container-fluid mb-5">
        <div class="card shadow-lg rounded-lg border-0">
            <div class="card-header text-white d-flex justify-content-between align-items-center"
                ...
                <h5 class="mb-0 text-white">Create Hero Slide</h5>
                <a href="{{ route('hero-slider.index') }}" class="btn admin-btn admin-btn-secondary admin-btn-sm">Back to Slider</a>
            </div>
                ...
                <form action="{{ route('hero-slider.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea name="description" rows="4" class="form-control form-control-lg">{{ old('description') }}</textarea>
                            @error('description')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
