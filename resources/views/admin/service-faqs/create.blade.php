        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card shadow-lg rounded-lg border-0">
                <div class="card-header d-flex justify-content-between align-items-center" style="background-color: #0A245D;">
                    <h5 class="text-white mb-0">Add Service FAQ</h5>
                    <a href="{{ route('service-faqs.index') }}" class="btn admin-btn admin-btn-secondary admin-btn-sm">
                        Back to FAQs
                    </a>
                </div>
                ...
                <div class="card-body p-5">
                    ...
                    <form action="{{ route('service-faqs.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-12 mb-4">
                                ...
                                <textarea id="answer" class="form-control form-control-lg shadow-sm rounded" name="answer" rows="5" required>{{ old('answer') }}</textarea>
                            </div>
