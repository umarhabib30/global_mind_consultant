    ...
    <div class="container-fluid mb-5">
        <div class="card shadow-lg rounded-lg border-0">
            <div class="card-header text-white d-flex justify-content-between align-items-center"
                ...
                <h5 class="mb-0 text-white">Create IELTS Popup</h5>
                <a href="{{ route('ielts-popup.index') }}" class="btn admin-btn admin-btn-secondary admin-btn-sm">Back to IELTS Popup List</a>
            </div>

            <div class="card-body p-4">
                <form action="{{ route('ielts-popup.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @include('admin.ielts-popup._form', ['popup' => null])
