...
>
  ...
  <div
    class="bg-black/30 backdrop-blur-md rounded-2xl shadow-lg p-6 sm:p-8 md:p-12 max-w-4xl w-full border border-white/30 text-center text-white"
  >
    <h1
      class="text-xl sm:text-2xl md:text-4xl font-bold mb-4 leading-snug"
    >
      Upcoming Events & Webinars
    </h1>
    <p
      class="text-sm sm:text-base md:text-lg mb-6 text-gray-100 px-2 sm:px-4"
    >
   ...
   class="relative overflow-hidden bg-[#74BF1A] text-white px-5 py-2.5 rounded-lg font-semibold group transition-all duration-300 inline-block">
    ...
    <!-- Social Icons -->
    <div
      class="flex flex-wrap items-center justify-center gap-4 sm:gap-6 mt-4"
    >
...
<section class="py-16 bg-[#F6F6F6]">
  <div class="px-6 md:px-12">
    ...
    <p class="text-base sm:text-lg md:text-xl text-center mb-12 text-gray-600">
      Stay informed and inspired! Join our upcoming seminars, university meetups, and study abroad orientation sessions.
    </p>
      ...
      <div class="bg-[#092962] rounded-2xl shadow-lg overflow-hidden">
        ...
        <div class="p-6 text-white">
          ...
          <p class="text-sm mb-4 text-gray-200">
            Meet top-ranked UK universities, explore scholarships, and get on-the-spot admission guidance from our experienced consultants.
          </p>
   ...
   class="mt-6 bg-[#74BF1A] text-white font-semibold py-2 px-8 rounded-lg hover:bg-green-500 transition w-full sm:w-auto inline-block">
    Register Now
      ...
      <div class="bg-[#092962] rounded-2xl shadow-lg overflow-hidden">
        <img
          src="images/single-blog.png"
          alt="Australia Study Visa Seminar"
          class="w-full h-60 object-cover p-4"
        />
        <div class="p-6 text-white">
   ...
   class="mt-6 bg-[#74BF1A] text-white font-semibold py-2 px-8 rounded-lg hover:bg-green-500 transition w-full sm:w-auto inline-block">
    Register Now
      ...
      <div class="bg-[#092962] rounded-2xl shadow-lg overflow-hidden">
        <img
          src="images/single-blog.png"
          alt="Canada Admissions Workshop"
          class="w-full h-60 object-cover p-4"
        />
        <div class="p-6 text-white">
          <h3 class="font-bold text-xl mb-3">Canada Admissions Workshop</h3>
          <p class="text-sm mb-4 text-gray-200">
            Get step-by-step assistance for applying to Canadian universities, writing SOPs, and understanding the visa process.
          </p>
   ...
   class="mt-6 bg-[#74BF1A] text-white font-semibold py-2 px-8 rounded-lg hover:bg-green-500 transition w-full sm:w-auto inline-block">
    ...
    <div class="text-center mt-10">
      <a
        href="#"
        class="text-[#092962] text-lg md:text-xl font-semibold hover:text-[#74BF1A] transition"
      >
        View More
      </a>
    </div>
...
<script>
  ...
  tabButtons.forEach((btn) => {
    ...
    <section class="py-16 bg-[#F6F6F6]">
  <div class="px-6 md:px-12">
    <div class="max-w-6xl mx-auto text-center bg-[#74BF1A] rounded-2xl p-16">
      <h1 class="text-2xl md:text-3xl font-bold mb-4 text-[#092962]">
      ...
      <button
        class="bg-[#092962] text-white px-12 py-2 rounded-lg hover:bg-green-600 transition"
      >
        Register Now
      </button>
    </div>
