...
>
  ...
  >
    <h2
      class="text-3xl sm:text-4xl md:text-5xl font-extrabold text-white mb-4 leading-tight"
    >
      Explore the Latest Insights on Scholarships & Admissions
    </h2>

    <p
      class="text-sm sm:text-base md:text-lg text-gray-200 mb-8 leading-relaxed"
    >
...
<section class="py-10">
  ...
  <div class="px-6 md:px-12">
    ...
    <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
      ...
      <div class="bg-[#74BF1A] rounded-2xl shadow-lg overflow-hidden">
        <img
          ...
          alt="Blog"
          class="w-full h-62 object-cover p-4 rounded-3xl"
        />
        <div class="p-6 text-white">
          ...
          <div class="flex items-center justify-between mb-3">
            ...
            <i
              class="fa-regular fa-heart text-white text-lg hover:text-red-500 transition"
            ></i>
          </div>
    ...
    <div class="text-center mt-10">
      <a
        href="#"
        class="text-[#092962] text-xl font-semibold hover:text-[#74BF1A] transition"
      >
        View More
      </a>
    </div>
...
<section class="py-16 bg-[#F6F6F6]">
  <div class="px-6 md:px-12">
    ...
    <p class="text-base sm:text-lg md:text-xl text-center mb-12 text-gray-600">
    ...
    <div class="flex flex-wrap justify-center mb-10 gap-4">
      <button class="tab-btn px-6 py-2 rounded-lg font-semibold text-white bg-[#092962] hover:bg-[#74BF1A] transition active" data-tab="all">All</button>
      <button class="tab-btn px-6 py-2 rounded-lg font-semibold text-white bg-[#092962] hover:bg-[#74BF1A] transition" data-tab="scholarships">Scholarships</button>
      <button class="tab-btn px-6 py-2 rounded-lg font-semibold text-white bg-[#092962] hover:bg-[#74BF1A] transition" data-tab="ielts">IELTS/PTE</button>
      <button class="tab-btn px-6 py-2 rounded-lg font-semibold text-white bg-[#092962] hover:bg-[#74BF1A] transition" data-tab="career">Career Counseling</button>
      <button class="tab-btn px-6 py-2 rounded-lg font-semibold text-white bg-[#092962] hover:bg-[#74BF1A] transition" data-tab="studyabroad">Study Abroad</button>
    </div>

    <!-- Cards Grid -->
    <div id="eventCards" class="grid gap-8 md:grid-cols-2 lg:grid-cols-3"></div>
...
<script>
  ...
  tabButtons.forEach(btn => {
    ...
    <!-----------------------------------HIGHLIGHT  SECTION----------------------------------------------->
<section class="relative bg-[#F6F6F6] py-16">
  <!-- Heading & Button  -->
  <div class="px-6 md:px-12 flex flex-col md:flex-row items-start md:items-center justify-between mb-8 gap-4">
  ...
  <div class="relative px-6 md:px-12 py-16">
    ...
    <div
      ...
      style="background-image: url('images/blogBg.jpg');"
    ></div>
    ...
    <!-- Content Container -->
    <div class="relative z-10 flex flex-col lg:flex-row gap-8 lg:gap-12 items-center lg:items-center justify-center">

      <!-- Left Card -->
      <div class="bg-white lg:w-2/5 rounded-2xl shadow-lg overflow-hidden flex-shrink-0">
        <img
          src="images/single-blog.png"
          alt="Scholarship Blog"
        ...
        <div class="p-6 text-white">
          ...
          <div class="flex items-center justify-between mb-3">
            ...
            <i
              class="fa-regular fa-heart text-[#062254] text-lg hover:text-red-500 transition"
            ></i>
          </div>
          ...
          <p class="text-sm md:text-base mb-3 text-black">
            Explore fully funded scholarship opportunities for Pakistani students in prestigious universities worldwide. Enhance your education without financial worries and achieve your academic goals.
          </p>
      ...
      <!-- Right Glassy Box -->
      <div class="lg:w-3/5 bg-white bg-opacity-20 backdrop-blur-md border border-white/30 rounded-2xl p-6 md:p-10 text-white flex flex-col justify-center items-center text-center">
        <div class="max-w-xl">
          <h2 class="text-2xl md:text-3xl font-bold mb-4">
            Fully Funded Scholarships for Pakistani Students
          </h2>
          <p class="text-sm md:text-base  text-left leading-relaxed">
            Each year, numerous scholarships become available for Pakistani students to study abroad. These scholarships cover tuition fees, accommodation, travel, and even monthly stipends. Students can apply based on academic excellence, leadership qualities, or specific fields of study. Early preparation and understanding eligibility criteria increase the chance of receiving these life-changing opportunities.
          </p>
        </div>
      </div>
