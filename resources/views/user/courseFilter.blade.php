    ...
    <section class="py-16 ">
        <div class="px-6 md:px-12 grid grid-cols-1 lg:grid-cols-10 items-center gap-10">
            ...
            <div class="lg:col-span-6 space-y-5">
                ...
                <button class="bg-[#092962] text-white px-6 py-2 rounded-lg hover:bg-[#0b3a8b] transition-all duration-300">
                    Read More
                </button>
            </div>
            ...
            <div class="lg:col-span-4 flex justify-center">
                <img src="{{ asset('images/art.jpg') }}" alt="Art & Humanities"
        ...
        <div class="px-6 md:px-12 flex gap-8 bg-[#f5f5f5]">
            <aside class="w-[280px] flex flex-col h-full sticky top-0">
                ...
                <div class="p-3 mt-2 bg-white shadow-lg rounded-md">
                    ...
                    <div class="flex justify-center items-center mt-4">
                        <button
                            class="bg-[#092962] text-white py-1.5 px-6 rounded-md text-sm cursor-pointer hover:bg-[#0b3a85] transition">
                            Discover
                        </button>
                    </div>
            ...
            <div class="w-full">
                ...
                <div class="flex justify-between items-center mb-4 ">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <!-- Apply Now Button -->
                        <button
                            class="bg-[#98D94A] text-white py-1.5 px-4 rounded-md text-sm hover:bg-[#7bc334] transition">
                            Apply Now
                        </button>
                    </div>
                ...
                <div class="flex justify-between items-center pb-10">
                    ...
                    <div class="flex items-center text-sm gap-2">
                        ...
                        <select
                            class="border rounded-md px-3 py-1.5 bg-white text-gray-700 focus:outline-none cursor-pointer">
                    ...
                    <div class="relative">
                        <select
                            class="appearance-none border rounded-md bg-white px-10 py-2 text-sm text-gray-700 w-48 focus:outline-none cursor-pointer">
                        ...
                        <!-- Dollar icon box -->
                        <div
                            class="absolute top-1/2 left-2 -translate-y-1/2 w-7 h-7 bg-gray-100 border rounded flex items-center justify-center pointer-events-none">
                            <img src="dollar-icon.png" class="w-4 h-4" />
                        </div>

                        <!-- Dropdown Arrow -->
                        <i
                            class="fa-solid fa-chevron-down absolute right-3 top-1/2 -translate-y-1/2 text-xs text-gray-600 pointer-events-none"></i>
                    </div>
                    ...
                    <div class="w-full bg-white rounded-md shadow-lg">
                        <div
                            ...
                            <div class="absolute top-2.5 right-3 flex items-center gap-2">
                                <img src="{{ asset('images/share.png') }}" alt="Arrow Icon"
                                    class="h-5 w-5 cursor-pointer">
                                <img src="{{ asset('images/heart.png') }}" alt="Heart Icon"
                                    class="h-5 w-5 cursor-pointer">
                            </div>
                            ...
                            <!-- Address -->
                            <p class="font-light text-center text-[12px] text-gray-900">Wellington Square, Oxford OX1 2JD,
                                UK</p>
                        </div>
                        ...
                        <div class="p-4 space-y-4">
                            ...
                            <div class="flex justify-center gap-4 pt-2">
                                <button
                                    class="bg-white border border-[#092962] text-[#092962] py-1.5 px-8 rounded-md text-sm shadow-md hover:bg-gray-50 transition">Discover</button>
                                <button
                                    class="bg-[#092962] text-white py-1.5 px-8 rounded-md text-sm shadow-md hover:bg-[#1f4c93] transition">Apply</button>
                            </div>
