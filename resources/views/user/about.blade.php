...
<section class="py-[10%] bg-[#F6F6F6]   ">
  <div class="px-4 sm:px-6 md:px-8 lg:px-36">
    <div class="flex flex-col lg:flex-row items-center gap-8">
      <!-- Left Content -->
      <div
        class="w-full lg:w-1/2 relative flex flex-col items-center lg:items-start"
      >
        <!-- Vertical 'About' -->
        <span
          class="vertical-text absolute -left-10 lg:-left-14 xl:-left-52 top-1/2 -translate-y-1/2 -rotate-90 text-xl sm:text-2xl md:text-8xl font-bold text-black tracking-wide"
        >
          About
        </span>
        ...
        <!-- Main Title -->
        <h2
          class="text-4xl sm:text-5xl md:text-8xl font-bold leading-tight text-center lg:text-left space-y-2 md:space-y-3"
        >
  ...
  <div class="px-6 md:px-12">
    <div class="flex flex-col lg:flex-row items-center gap-10">
      ...
      <div class="w-full lg:w-1/2">
        ...
        <p class="text-gray-600 mb-8 text-base sm:text-lg md:text-xl">
